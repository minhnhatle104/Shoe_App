import { StyleSheet, Text, View, TouchableOpacity, SafeAreaView, TextInput, Image, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard } from 'react-native'
...
const Login = (props: Props) => {
    ...
    const formValuesLogin: formLoginModel = {
        email: "",
        password: "",
    }
